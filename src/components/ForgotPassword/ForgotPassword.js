...
function ForgotPassword() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            setError('')
            setLoading(true)
            await resetPassword(contact.email)
        ...
        <Grid>
            <Paper elevation={20} style={paperStyle}>
                <Grid align='center'>
                    ...
                    <h2 style={headerStyle}>Password Reset</h2>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <Button className="button" disabled={loading} type='submit' variant='contained' color='primary'>Reset Password</Button>
                </form>
